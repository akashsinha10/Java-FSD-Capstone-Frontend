...
export class ProductapiService {
  ...
  private url:string = "http://localhost:8083/api/ver2/product";
  constructor(private httpClient : HttpClient) { }
  
  public getproductsdata(search : string){
    return this.httpClient.get(this.url+"/getproductsdata?name="+search);
  }
